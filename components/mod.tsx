...
export function Tech(
	...
	return (
		<span class="inline-flex items-center gap-1 bg-gray-250 rounded-full px-3 py-1 text-sm font-semibold select-none text-gray-700 mr-2 mb-2 dark:bg-gray-700 dark:text-gray-200">
