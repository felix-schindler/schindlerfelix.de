...
<div id="tldr">
	<p>Available for <mark class="mono">0.99€</mark> in the App Store</p>

	<p>
		It's in early development and therefore bugs and missing features are expected. Any feature
		requests or issues can be reported in the GitLab repository.
	</p>

	<p>
		It's open source and licensed under GNU AGPLv3. I will reserve the right to make it closed
		source at any point.
	</p>
</div>
...
<ul id="links">
	<li>
		<a href="https://apps.apple.com/us/app/tanuki-for-gitlab/id6446419487">
			<svg
	...
	<li>
		...
		\
		<a href="https://gitlab.com/felix-schindler/gitlab-ios/-/milestones/3#tab-issues"
